...
class Yolo:
    def __init__(self, config_path: str, weights_path: str, names_path: str, conf_thresh: float, nms_thresh: float, use_cuda: bool = False) -> None:
        # save thresholds
        self.ct = conf_thresh
        ...
        print("Finished: " + str(weights_path))
        self.classes = []
